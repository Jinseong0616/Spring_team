...
- 웹 페이지 전체를 다시 로딩하지 않고도, 웹 페이지의 일부부만을 갱신할 수 있다.
 ...
 */
 ...
 function createRequest(){
	 /*
	 JavaScript를 이용하여 서버로 정보를 보내는 HTTP request를 만들기 위해서는 이런
	 기능을 제공하는 객체가 필요하다.
	 ...
	 // ActiveXObjectf를 지원하는 브라우저면 오브젝트를 리턴하고
 ...
 function sendRequest(url, param, callback, method){
	 ...
	 // 예를 들자면 send()를 호출하기전에 아래와 같은 형태로 send()로 보낼 쿼리를 이용해야 한다.
